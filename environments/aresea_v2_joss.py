import joss
from joss.accelerator import Segment
...
from accelerator_environments.envs.ares.aresea_v2 import ARESEA
...
class ARESEAJOSS(ARESEA):
    ...
    def __init__(self, random_incoming=True, random_actuators=True, simulate_screen=True, **kwargs):
        ...
        cell = utils.subcell_of(lattice.cell, "ARLIMCXG4A", "ARMRBSCR1")
        self.segment = Segment.from_ocelot(cell)
    ...
    @property
    def actuators(self):
        return np.array([self.segment.ARLIMCXG4A.angle,
                         self.segment.ARLIMCXG4B.angle,
                         self.segment.ARLIMCHM2.angle,
                         self.segment.ARLIMCVM2.angle,
    ...
    def actuators(self, values):
        self.segment.ARLIMCXG4A.angle = values[0]
        self.segment.ARLIMCXG4B.angle = values[1]
        self.segment.ARLIMCHM2.angle = values[2]
        self.segment.ARLIMCVM2.angle = values[3]
        self.segment.AREAMQZM1.k1 = values[4]
        self.segment.AREAMQZM2.k1 = values[5]
        self.segment.AREAMQZM3.k1 = values[6]
        self.segment.AREAMCVM1.angle = values[7]
        self.segment.AREAMCHM1.angle = values[8]
