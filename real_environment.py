...
MagnetSettings = namedtuple("MagnetSettings", ["AREAMQZM1","AREAMQZM2","AREAMCVM1","AREAMQZM3","AREAMCHM1"])
...
class ARESEA(gym.Env):
    ...
    def render(self, mode="human"):
        ...
        black = (0, 0, 0)
        img = cv2.putText(img, f"Q1={magnet_settings.AREAMQZM1:.2f}", (15,545), cv2.FONT_HERSHEY_SIMPLEX, 1, black)
        img = cv2.putText(img, f"Q2={magnet_settings.AREAMQZM2:.2f}", (215,545), cv2.FONT_HERSHEY_SIMPLEX, 1, black)
        img = cv2.putText(img, f"CV={magnet_settings.AREAMCVM1*1e3:.2f}", (415,545), cv2.FONT_HERSHEY_SIMPLEX, 1, black)
        img = cv2.putText(img, f"Q3={magnet_settings.AREAMQZM3:.2f}", (615,545), cv2.FONT_HERSHEY_SIMPLEX, 1, black)
        img = cv2.putText(img, f"CH={magnet_settings.AREAMCHM1*1e3:.2f}", (15,585), cv2.FONT_HERSHEY_SIMPLEX, 1, black)
    ...
    def read_magnets(self):
        return MagnetSettings(
            AREAMQZM1=pydoocs.read("SINBAD.MAGNETS/MAGNET.ML/AREAMQZM1/STRENGTH.RBV")["data"],
            AREAMQZM2=pydoocs.read("SINBAD.MAGNETS/MAGNET.ML/AREAMQZM2/STRENGTH.RBV")["data"],
            AREAMCVM1=pydoocs.read("SINBAD.MAGNETS/MAGNET.ML/AREAMCVM1/KICK_MRAD.RBV")["data"] / 1000,
            AREAMQZM3=pydoocs.read("SINBAD.MAGNETS/MAGNET.ML/AREAMQZM3/STRENGTH.RBV")["data"],
            AREAMCHM1=pydoocs.read("SINBAD.MAGNETS/MAGNET.ML/AREAMCHM1/KICK_MRAD.RBV")["data"] / 1000
        )

    def set_magnets(self, settings, wait=True):
        pydoocs.write("SINBAD.MAGNETS/MAGNET.ML/AREAMQZM1/STRENGTH.SP", settings.AREAMQZM1)
        pydoocs.write("SINBAD.MAGNETS/MAGNET.ML/AREAMQZM2/STRENGTH.SP", settings.AREAMQZM2)
        pydoocs.write("SINBAD.MAGNETS/MAGNET.ML/AREAMCVM1/KICK_MRAD.SP", settings.AREAMCVM1 * 1000)
        pydoocs.write("SINBAD.MAGNETS/MAGNET.ML/AREAMQZM3/STRENGTH.SP", settings.AREAMQZM3)
        pydoocs.write("SINBAD.MAGNETS/MAGNET.ML/AREAMCHM1/KICK_MRAD.SP", settings.AREAMCHM1 * 1000)
